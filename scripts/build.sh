...
uglifyjs js/prototypes.js js/model.js js/storage.js js/alert.js js/information.js js/tuner.js js/cents_view.js js/tuner_view.js js/volume_view.js js/main.js js/install.js service_worker.js -o js/bundle.js
